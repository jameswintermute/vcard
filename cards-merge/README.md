...
=======
# cards-merge — Source files

Drop your exported contact files here before running a merge.

**How to export:**

- **iCloud:** Settings → [your name] → iCloud → Contacts → Export vCard
- **Proton Mail:** Contacts → ••• menu → Export
- **Google:** contacts.google.com → Export → vCard

Then run `python3 start.py` and choose option **1**.
>>>>>>> 729d9e9 (changes)
